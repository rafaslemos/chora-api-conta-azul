...
/**
 * Página intermediária para redirecionar de /auth/confirm (sem hash) para /#/auth/confirm (com hash)
 * Necessária porque o Supabase não preserva hash no redirect_to dos emails
 */
const AuthConfirmRedirect: React.FC = () => {
...
export default AuthConfirmRedirect;
