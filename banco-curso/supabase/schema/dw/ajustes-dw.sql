-- ============================================
-- AJUSTES NA ESTRUTURA DO DATA WAREHOUSE
...
CREATE OR REPLACE FUNCTION dw.verificar_integridade_dw(p_cliente_id UUID DEFAULT NULL)
RETURNS TABLE(
    tabela TEXT,
    problema TEXT,
    quantidade BIGINT
...
COMMENT ON FUNCTION dw.verificar_integridade_dw(UUID) IS 'Verifica integridade referencial do DW. Retorna problemas encontrados com quantidade de registros afetados.';
