...
const MIGRATION_032_CREATE_CREDENTIAL_RPCS = `
-- ============================================================================
-- Migration 032: Criar RPCs de credenciais (app_core)
-- ============================================================================
-- create_tenant_credential, update_tenant_credential, get_tenant_credential_decrypted.
-- Dependem de get_encryption_key, encrypt_token, decrypt_token (criados em 006/setup).
-- ============================================================================
...
const MIGRATION_033_GRANT_EXECUTE_CREDENTIAL_RPCS = `
-- ============================================================================
